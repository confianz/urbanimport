...
class SaleOrder(models.Model):
    ...
    def action_draft(self):
        for record in self:
            record.payment_profile_id = False
    ...
    def create_down_payment(self, total_amount, handling_fee, invoice_total, paid_amount):
        for sale_order in self:
            ...
            if sale_advance.advance_payment_method == 'delivered':
                ...
                amount = sale_advance.fixed_amount
    ...
    def write(self, vals):
        ...
        for rec in self:
            ...
            if vals.get('payment_profile_id', False):
                rec.partner_invoice_id and rec.partner_invoice_id.write({'payment_id': vals.get('payment_profile_id', False)})
        return res
