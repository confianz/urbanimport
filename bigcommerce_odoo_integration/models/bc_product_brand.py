...
class BigcommerceProductBrand(models.Model):
    ...
    def bigcommerce_to_odoo_import_product_brands(self, warehouse_id=False, bigcommerce_store_ids=False):
        for bigcommerce_store_id in bigcommerce_store_ids:
            ...
            brand_operation_id = bigcommerce_store_id.create_bigcommerce_operation('brand', 'import',
            ...
            try:
                ...
                if response_data.status_code in [200, 201]:
                    ...
                    if total_pages > 1:
                        while (total_pages != 0):
                            try:
                                ...
                                _logger.info("Getting an Error In Import Product Brand Response {}".format(e))
                                process_message = "Getting an Error In Import Product Brand Response {}".format(e)
                                bigcommerce_store_id.create_bigcommerce_operation_detail('brand', 'import',
                                                                                         page_response_data,
                    ...
                    for brand_response_page in brand_response_pages:
                        for record in brand_response_page:
                            brand_id = self.env['bc.product.brand'].search([('bc_brand_id', '=', record.get('id')), (
                            ...
                            if not brand_id:
                                ...
                                req_data = record
                            bigcommerce_store_id.create_bigcommerce_operation_detail('brand', 'import', req_data,
                                                                                     response_data, brand_operation_id,
                                                                                     warehouse_id, False,
                                                                                     process_message)
                            self._cr.commit()
                ...
                process_message = "Getting an Error In Import Product Brand Response {}".format(e)
                bigcommerce_store_id.create_bigcommerce_operation_detail('brand', 'import', response_data,
                                                                         brand_process_message, brand_operation_id,
                                                                         warehouse_id, True, process_message)
            brand_operation_id and brand_operation_id.write({'bigcommerce_message': brand_process_message})
