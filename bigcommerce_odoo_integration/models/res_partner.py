...
class ResPartner(models.Model):
    ...
    def bigcommerce_to_odoo_import_customers(self, warehouse_id=False, bigcommerce_store_ids=False):
        for bigcommerce_store_id in bigcommerce_store_ids:
            ...
            if not category_operation_id:
                category_operation_id = self.create_bigcommerce_operation('customer', 'import', bigcommerce_store_id,
            ...
            try:
                ...
                if response_data.status_code in [200, 201]:
                    ...
                    for customer_response_page in customer_response_pages:
                        for record in customer_response_page:
                            ...
                            self._cr.commit()
                            try:
                                self.add_customer_address(customer_id, bigcommerce_store_id, category_operation_id,
                                                          warehouse_id)
                            except Exception as e:
                                continue
                ...
                self.create_bigcommerce_operation_detail('customer', 'import', response_data, customer_process_message,
                                                         category_operation_id, warehouse_id, True, customer_message)
    ...
    def add_customer_address(self, customer_id=False, bigcommerce_store_id=False, category_operation_id=False,
                             warehouse_id=False):
        req_data = False
        customer_process_message = "Process Completed Successfully!"
        if customer_id and customer_id.bigcommerce_customer_id:
            try:
                ...
                if response_data.status_code in [200, 201, 204]:
                    ...
                    for record in response_data:
                        ...
                        customer_id.street2 = record.get("street_2", "")
            ...
            self.create_bigcommerce_operation_detail('customer', 'import', False, False,
                                                     category_operation_id, False, False,
